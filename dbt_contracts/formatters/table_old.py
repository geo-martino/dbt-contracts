...
from dbt_contracts.formatters._core import KeysT, ResultFormatter, get_value_from_object, get_values_from_object
...
class TableFormatter[T](ResultFormatter[T]):
...
class GroupedTableFormatter[T](ResultFormatter[T]):
    """
